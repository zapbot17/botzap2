...
const vcard = 'BEGIN:VCARD\n' 
            ...
            + 'FN:Affis Admin\n' 
            + 'ORG: Pengembang XBot;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=556392896296:+556392896296\n' 
            + 'END:VCARD' 
blocked = []   
prefix = '#'
limitawal = 30
...
/******** OWNER NUMBER**********/
const ownerNumber = ["+55799839-2349@s.whatsapp.net","+55 79 9839-2349@s.whatsapp.net"] 
/************************************/
          ...
          const checkLimit = (sender) => {
           ...
           return false
            ...
            if (bad.includes(messagesC)) {
                if (!isGroupAdmins) {
                    return reply("POR FAVOR DIGA OLÁ!! 😠")
                    ...
                    return reply( "POR FAVOR SE CUIDE 😇")
                }
            }
        }
				...
				if (messagesC.includes("://chat.whatsapp.com/")){
					...
					var kic = `${sender.split("@")[0]}@s.whatsapp.net`
						reply(`Link de grupo detectado ${sender.split("@")[0]} Você será expulso do grupo em 5 seg❤`)
						setTimeout( () => {
